...
func (s *BookingAppointmentTestSite) TestUserCRUD() {
	...
	patient := &patients.CreatedPatient{
		Id:             "6169c276-cc8e-4129-a9c2-76cc8e212988",
		FirstName:      "Husanboy",
		LastName:       "Gofurov",
		BirthDate:      brithDate,
		Gender:         "male",
	...
	createReq := booked_appointments.CreateAppointment{
		DepartmentId:    "48655b3a-9641-413f-b43e-b1a52de633ea",
		DoctorId:        "c98ab69b-3f29-462a-8ab6-9b3f29862afe",
	...
	s.Suite.Equal(createRes.PatientStatus, createReq.PatientStatus)
	...
	s.Suite.Equal(getRes.PatientStatus, createRes.PatientStatus)
	...
	s.Suite.Equal(upRes.PatientStatus, upReq.PatientStatus)
